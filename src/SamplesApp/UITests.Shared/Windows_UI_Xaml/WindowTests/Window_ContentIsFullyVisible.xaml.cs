...
{
	[Sample("Window", Description = "There should be a fully visible orange border above.")]
    public sealed partial class Window_ContentIsFullyVisible : UserControl
    {
		...
		{
			// Diagnostic information that's helpful when this test fails and you want to examine a screenshot to compare the reported size of the content versus its actual size.
